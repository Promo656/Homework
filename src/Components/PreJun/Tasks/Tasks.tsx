    ...
    return (
        <div className={s.container}>
            ...
            <div className={s.btncontainer}>
                <Button variant={"outlined"} onClick={() => filterTasks("all")}>All</Button>
                <Button variant={"outlined"} onClick={() => filterTasks("low")}>LOW</Button>
                <Button variant={"outlined"} onClick={() => filterTasks("middle")}>MIDDLE</Button>
                <Button variant={"outlined"} onClick={() => filterTasks("high")}>HIGH</Button>
            </div>
        </div>
    )
}